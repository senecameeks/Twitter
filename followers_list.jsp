...
<body class="user-style-theme1">
	...
	java.sql.ResultSet rs_followers1 = stmt8.executeQuery(followers_q);
	
	while(rs_followers1.next())
	{ //open
		username = rs_followers1.getString("username");
		fullname = rs_followers1.getString("fullname");
