...
<%
    ...
    try {
	 ...
	 String following_q = "SELECT user_t.username, user_t.fullname from user_t inner join follow_rel on follow_rel.user_t_user_id_followee=user_t.user_id WHERE user_t_user_id_follower=" + "'"+ u_id + "'"; 		
...
<body class="user-style-theme1">
	...
	java.sql.ResultSet rs_following1 = stmt8.executeQuery(following_q);
	
	while(rs_following1.next())
	{ //open
		username = rs_following1.getString("username");
		fullname = rs_following1.getString("fullname");
                                      ...
                                      <%
                                      	...
                                      	for(int i = 0; i < words.length; i ++)
                                      	{
        									 ...
        									 if(words[i].substring(0, 1).equals("#"))
        									 {
             									...
             									words[i] = "<a href='hashtag_tweets.jsp?hashtag=" +  h_id + "'>" + hash + "</a>" + " ";							
