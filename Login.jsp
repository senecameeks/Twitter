...
<%
  ...
  { 
    if(msg.contains("fail")){
      ...
      out.println("failure: Username/Email already taken or Invalid Username/Password combination."); 
    }
  ...
  <div class="front-card">
    ...
    <div class="front-signup">
      ...
      <form action="newUser.jsp" class="signup" method="get">
        <div class="Fullname">
          <input type="text" id="signup-full-name" autocomplete="off" maxlength="20" name="fullname" placeholder="Full Name">
        </div>
        <div class="Username">
